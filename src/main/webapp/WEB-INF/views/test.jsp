...
.map_wrap {position:relative;width:640px;height:360px;} /* 지도의 크기를 640x360으로 조정 */
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = {
        center: new kakao.maps.LatLng(36.966340286186174, 127.93493692266561), // 지도의 중심좌표
        level: 5 // 지도의 확대 레벨
    };  
...
// 각 카테고리 클릭시 카테고리 검색을 요청하도록 이벤트를 등록합니다
